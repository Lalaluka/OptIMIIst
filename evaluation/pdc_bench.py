...
train_dir = "evaluation/logs/PDC2024/Training Logs"
base_dir = "evaluation/logs/PDC2024/Base Logs"
test_dir = "evaluation/logs/PDC2024/Test Logs"
truth_dir = "evaluation/logs/PDC2024/Ground Truth Logs"
...
def pdc_bench(result_dir, algorithm, name):
    ...
    for log_file in os.listdir(train_dir):
        ...
        results = Parallel(n_jobs=-1)(delayed(process_case)(case) for case in test["case:concept:name"].unique())
